defmodule ElixirCocktailUrlRedirects.Endpoint do
  use Phoenix.Endpoint, otp_app: :elixir_cocktail_url_redirects
  ...
  plug Plug.Static,
    at: "/", from: :elixir_cocktail_url_redirects, gzip: false,
